...
import { OrderReceiptComponent } from './parts/order-receipt.component';
...
@Component({
    ...
    directives: [OrderServicesComponent, OrderEventsComponent, OrderPreferencesComponent, OrderReceiptComponent, OrderFeedbackComponent]
})
